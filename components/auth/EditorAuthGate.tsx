    ...
    return (
      <main className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-[#f7f8fc] p-5">
        ...
        <div className="relative w-full max-w-md rounded-[30px] border border-white bg-white/90 p-7 text-center shadow-2xl shadow-violet-100/60 backdrop-blur">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-violet-600 text-xl font-black text-white shadow-lg">P</div>
          <h1 className="mt-5 text-2xl font-black tracking-tight text-slate-950">Sign in to start designing</h1>
          <p className="mx-auto mt-2 max-w-sm text-sm leading-6 text-slate-500">Your account keeps your PostMaker workspace private and prepares your designs for cloud sync across mobile and desktop.</p>
          <button type="button" onClick={() => openAuth("signin")} className="mt-6 h-11 w-full rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-500 text-sm font-black text-white shadow-lg shadow-violet-100">Log in</button>
