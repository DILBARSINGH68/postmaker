...
function IconButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-white transition hover:bg-white/15 disabled:opacity-35"
    >
      {children}
    </button>
  );
        ...
        <div className="hidden h-full items-center justify-between px-4 md:flex">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <input
              ...
              className="w-40 min-w-0 rounded-lg border px-3 py-2 text-sm outline-none focus:border-black md:w-60"
          ...
          <div className="flex items-center gap-2">
            <button onClick={props.onResize} className="rounded-lg border px-3 py-2 text-xs font-medium hover:bg-gray-50">
              Resize
            </button>
            <button onClick={props.onProjects} className="hidden rounded-lg border px-3 py-2 text-xs lg:block">
              Projects
            </button>
            <button onClick={props.onSave} className="hidden rounded-lg border px-3 py-2 text-xs lg:block">
              Save
            </button>
            ...
            <button onClick={props.onDownload} className="rounded-lg bg-black px-4 py-2 text-xs font-semibold text-white hover:bg-gray-800">
              Download
            </button>
          </div>
        </div>
